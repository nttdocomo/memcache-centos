...
RUN set -x \
    ...
    && yum --nogpg install -y perl perl-core perl-Test-Harness make zlib-devel gcc \
	&& perl -v \
...
# see https://github.com/docker-library/memcached/pull/54#issuecomment-562797748 and https://bugs.debian.org/927461 for why we have to munge openssl.cnf
	...
	&& yum autoremove -y perl perl-core perl-Test-Harness make zlib-devel gcc dpkg-dev
